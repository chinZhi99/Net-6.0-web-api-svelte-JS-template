    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 3, 4, 96);
    			add_location(h30, file$3, 4, 4, 120);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "add-name");
    			attr_dev(input0, "placeholder", "New to-do");
    			add_location(input0, file$3, 6, 6, 216);
    			attr_dev(input1, "type", "submit");
    			input1.value = "Add";
    			add_location(input1, file$3, 7, 6, 283);
    			attr_dev(form0, "action", "javascript:void(0);");
    			attr_dev(form0, "method", "POST");
    			attr_dev(form0, "onsubmit", "addItem()");
    			add_location(form0, file$3, 5, 4, 138);
    			add_location(h31, file$3, 11, 6, 388);
    			attr_dev(input2, "type", "hidden");
    			attr_dev(input2, "id", "edit-id");
    			add_location(input2, file$3, 13, 8, 478);
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "id", "edit-isComplete");
    			add_location(input3, file$3, 14, 8, 524);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "id", "edit-name");
    			add_location(input4, file$3, 15, 8, 580);
    			attr_dev(input5, "type", "submit");
    			input5.value = "Save";
    			add_location(input5, file$3, 16, 8, 626);
    			attr_dev(a, "onclick", "closeInput()");
    			attr_dev(a, "aria-label", "Close");
    			add_location(a, file$3, 17, 8, 672);
    			attr_dev(form1, "action", "javascript:void(0);");
    			attr_dev(form1, "onsubmit", "updateItem()");
    			add_location(form1, file$3, 12, 6, 409);
    			attr_dev(div1, "id", "editForm");
    			set_style(div1, "display", "none");
    			add_location(div1, file$3, 10, 4, 339);
    			attr_dev(p, "id", "counter");
    			add_location(p, file$3, 21, 4, 764);
    			add_location(th0, file$3, 25, 8, 819);
    			add_location(th1, file$3, 26, 8, 850);
    			add_location(th2, file$3, 27, 8, 873);
    			add_location(th3, file$3, 28, 8, 889);
    			add_location(tr, file$3, 24, 6, 805);
    			attr_dev(tbody, "id", "todos");
    			add_location(tbody, file$3, 30, 6, 916);
    			add_location(table, file$3, 23, 4, 790);
    			attr_dev(div2, "class", "col-10 border border-secondary");
    			add_location(div2, file$3, 2, 2, 46);
    			attr_dev(div3, "class", "col-1");
    			add_location(div3, file$3, 33, 2, 964);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h31, file$2, 11, 8, 397);
    			attr_dev(input2, "type", "hidden");
    			attr_dev(input2, "id", "edit-id");
    			add_location(input2, file$2, 13, 10, 491);
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "id", "edit-isComplete");
    			add_location(input3, file$2, 14, 10, 539);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "id", "edit-name");
    			add_location(input4, file$2, 15, 10, 597);
    			attr_dev(input5, "type", "submit");
    			input5.value = "Save";
    			add_location(input5, file$2, 16, 10, 645);
    			attr_dev(a, "onclick", "closeInput()");
    			attr_dev(a, "aria-label", "Close");
    			add_location(a, file$2, 17, 10, 693);
    			attr_dev(form1, "action", "javascript:void(0);");
    			attr_dev(form1, "onsubmit", "updateItem()");
    			add_location(form1, file$2, 12, 8, 420);
    			attr_dev(div1, "id", "editForm");
    			add_location(div1, file$2, 10, 6, 368);
    			attr_dev(p, "id", "counter");
    			add_location(p, file$2, 21, 6, 793);
    			add_location(th0, file$2, 25, 10, 856);
    			add_location(th1, file$2, 26, 10, 889);
    			add_location(th2, file$2, 27, 10, 914);
    			add_location(th3, file$2, 28, 10, 932);
    			add_location(tr, file$2, 24, 8, 840);
    			attr_dev(tbody, "id", "todos");
    			add_location(tbody, file$2, 30, 8, 963);
    			add_location(table, file$2, 23, 6, 823);
    			attr_dev(div2, "class", "col-10 border border-secondary");
    			add_location(div2, file$2, 2, 4, 50);
    			attr_dev(div3, "class", "col-1");
    			add_location(div3, file$2, 33, 4, 1017);
    			attr_dev(div4, "class", "row");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 48, 0, 1496);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
