...
var app = (function () {
    ...
    const file$4 = "svelte-app\\components\\navbar.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$4, 18, 4, 436);
    			attr_dev(nav, "class", "navbar navbar-expand-lg navbar-dark bg-dark");
    			add_location(nav, file$4, 17, 0, 373);
    		},
    ...
    const file$3 = "svelte-app\\pages\\index.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 3, 8, 108);
    			attr_dev(div1, "class", "col-10 border border-secondary");
    			add_location(div1, file$3, 2, 4, 54);
    			attr_dev(div2, "class", "col-1");
    			add_location(div2, file$3, 5, 4, 140);
    ...
    const file$2 = "svelte-app\\pages\\todo.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 3, 4, 96);
    			add_location(h30, file$2, 4, 4, 121);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "add-name");
    			attr_dev(input0, "placeholder", "New to-do");
    			add_location(input0, file$2, 6, 6, 217);
    			attr_dev(input1, "type", "submit");
    			input1.value = "Add";
    			add_location(input1, file$2, 7, 6, 284);
    			attr_dev(form0, "action", "javascript:void(0);");
    			attr_dev(form0, "method", "POST");
    			attr_dev(form0, "onsubmit", "addItem()");
    			add_location(form0, file$2, 5, 4, 139);
    			add_location(h31, file$2, 11, 6, 367);
    			attr_dev(input2, "type", "hidden");
    			attr_dev(input2, "id", "edit-id");
    			add_location(input2, file$2, 13, 8, 457);
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "id", "edit-isComplete");
    			add_location(input3, file$2, 14, 8, 503);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "id", "edit-name");
    			add_location(input4, file$2, 15, 8, 559);
    			attr_dev(input5, "type", "submit");
    			input5.value = "Save";
    			add_location(input5, file$2, 16, 8, 605);
    			attr_dev(a, "onclick", "closeInput()");
    			attr_dev(a, "aria-label", "Close");
    			add_location(a, file$2, 17, 8, 651);
    			attr_dev(form1, "action", "javascript:void(0);");
    			attr_dev(form1, "onsubmit", "updateItem()");
    			add_location(form1, file$2, 12, 6, 388);
    			attr_dev(div1, "id", "editForm");
    			add_location(div1, file$2, 10, 4, 340);
    			attr_dev(p, "id", "counter");
    			add_location(p, file$2, 21, 4, 743);
    			add_location(th0, file$2, 25, 8, 798);
    			add_location(th1, file$2, 26, 8, 829);
    			add_location(th2, file$2, 27, 8, 852);
    			add_location(th3, file$2, 28, 8, 868);
    			add_location(tr, file$2, 24, 6, 784);
    			attr_dev(tbody, "id", "todos");
    			add_location(tbody, file$2, 30, 6, 895);
    			add_location(table, file$2, 23, 4, 769);
    			attr_dev(div2, "class", "col-10 border border-secondary");
    			add_location(div2, file$2, 2, 2, 46);
    			attr_dev(div3, "class", "col-1");
    			add_location(div3, file$2, 33, 2, 943);
    ...
    // (25:0) <Navbar on:message={handlePageNavigationOnMessage}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(25:0) <Navbar on:message={handlePageNavigationOnMessage}>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(39:1) {#if currentPage == \\\"Index\\\"}",
    		ctx
    	});
