...
var app = (function () {
    ...
    /* svelte-app\pages\todotest.svelte generated by Svelte v3.49.0 */

    const file$2 = "svelte-app\\pages\\todotest.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h30, file$2, 4, 6, 133);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "add-name");
    			attr_dev(input0, "placeholder", "New to-do");
    			add_location(input0, file$2, 6, 8, 233);
    			attr_dev(input1, "type", "submit");
    			input1.value = "Add";
    			add_location(input1, file$2, 7, 8, 302);
    			attr_dev(form0, "action", "javascript:void(0);");
    			attr_dev(form0, "method", "POST");
    			attr_dev(form0, "onsubmit", "addItem()");
    			add_location(form0, file$2, 5, 6, 153);
    			add_location(h31, file$2, 11, 8, 415);
    			attr_dev(input2, "type", "hidden");
    			attr_dev(input2, "id", "edit-id");
    			add_location(input2, file$2, 13, 10, 509);
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "id", "edit-isComplete");
    			add_location(input3, file$2, 14, 10, 557);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "id", "edit-name");
    			add_location(input4, file$2, 15, 10, 615);
    			attr_dev(input5, "type", "submit");
    			input5.value = "Save";
    			add_location(input5, file$2, 16, 10, 663);
    			attr_dev(a, "onclick", "closeInput()");
    			attr_dev(a, "aria-label", "Close");
    			add_location(a, file$2, 17, 10, 711);
    			attr_dev(form1, "action", "javascript:void(0);");
    			attr_dev(form1, "onsubmit", "updateItem()");
    			add_location(form1, file$2, 12, 8, 438);
    			attr_dev(div1, "id", "editForm");
    			set_style(div1, "display", "none");
    			add_location(div1, file$2, 10, 6, 364);
    			attr_dev(p, "id", "counter");
    			add_location(p, file$2, 21, 6, 811);
    			add_location(th0, file$2, 25, 10, 874);
    			add_location(th1, file$2, 26, 10, 907);
    			add_location(th2, file$2, 27, 10, 932);
    			add_location(th3, file$2, 28, 10, 950);
    			add_location(tr, file$2, 24, 8, 858);
    			attr_dev(tbody, "id", "todos");
    			add_location(tbody, file$2, 30, 8, 981);
    			add_location(table, file$2, 23, 6, 841);
    			attr_dev(div2, "class", "col-10 border border-secondary");
    			add_location(div2, file$2, 2, 4, 50);
    			attr_dev(div3, "class", "col-1");
    			add_location(div3, file$2, 33, 4, 1035);
    			attr_dev(div4, "class", "row");
    ...
    function instance$2($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Todotest', slots, []);
    	getItems();
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Todotest> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Todotest extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file, 27, 2, 708);
    			attr_dev(li0, "class", "nav-item");
    			add_location(li0, file, 26, 1, 684);
    			attr_dev(a1, "class", "nav-link");
    			attr_dev(a1, "aria-current", "Todo");
    			attr_dev(a1, "href", "#");
    			toggle_class(a1, "active", /*currentPage*/ ctx[0] === "Todo");
    			add_location(a1, file, 32, 2, 900);
    			attr_dev(li1, "class", "nav-item");
    			add_location(li1, file, 31, 1, 876);
    			attr_dev(a2, "class", "nav-link");
    			attr_dev(a2, "aria-current", "Todo");
    			attr_dev(a2, "href", "#");
    			toggle_class(a2, "active", /*currentPage*/ ctx[0] === "TodoTest");
    			add_location(a2, file, 37, 2, 1089);
    			attr_dev(li2, "class", "nav-item");
    			add_location(li2, file, 36, 1, 1065);
    			attr_dev(a3, "class", "nav-link");
    			attr_dev(a3, "aria-current", "Todo");
    			attr_dev(a3, "href", "#");
    			toggle_class(a3, "active", /*currentPage*/ ctx[0] === "NotFound");
    			add_location(a3, file, 42, 2, 1290);
    			attr_dev(li3, "class", "nav-item");
    			add_location(li3, file, 41, 1, 1266);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	let todotest;
    	let current;
    	todotest = new Todotest({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(todotest.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(todotest, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(todotest.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(todotest.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(todotest, detaching);
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*currentPage*/ ctx[0] == "TodoTest") return 2;
    		return 3;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 48, 0, 1477);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler_2 = () => handlePageNavigationOnClick("TodoTest");
